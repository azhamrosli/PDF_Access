...
#Region "Insert the page function here"
    ...
    Private Sub Page1()
        ...
        Try
            ...
            strSQL = "select tp_name , tp_ref_no_prefix, (tp_ref_no1 + tp_ref_no2 + tp_ref_no3)," _
            ...
            dr = datHandler.GetDataReader("select tp_last_passport_no, tp_bwa, TP_WORKER_APPROVEDATE, TP_COM_ADD_STATUS, TP_DOB, TP_HW_DOB from taxp_profile2 where" _
                        & " tp_ref_no= '" & pdfForm.GetRefNo & "'")


            If ds.Tables(0).Rows.Count > 0 Then
                If Not IsDBNull(ds.Tables(0).Rows(0).Item(0)) Then
                    strArray = SplitText(ds.Tables(0).Rows(0).Item(0).ToString(), 80)
                ...
                If Not IsDBNull(ds.Tables(0).Rows(0).Item(2)) Then
                    If Not String.IsNullOrEmpty(ds.Tables(0).Rows(0).Item(2).ToString) Then
                        pdfFormFields.SetField(pdfFieldPath & "II_2[0]", (ds.Tables(0).Rows(0).Item(1).ToString) + " " + (ds.Tables(0).Rows(0).Item(2).ToString))
                    End If
                End If
                ...
                If dr.Read() Then
                    ...
                    End If
                    'azham
                    If Not IsDBNull(dr("TP_DOB")) Then
                        If Not String.IsNullOrEmpty(dr("TP_DOB")) Then
                            pdfFormFields.SetField(pdfFieldPath & "ZK_5[0]", Format(CDate(dr("TP_DOB").ToString), "dd-MM-yyyy"))
                        Else
                            pdfFormFields.SetField(pdfFieldPath & "ZK_5[0]", "---")
                        End If
                    Else
                        pdfFormFields.SetField(pdfFieldPath & "ZK_5[0]", "---")
                    End If
            ...
            If dr.Read() Then
                ...
                If dr2.Read() Then
                    ...
                    If Not IsDBNull(dr.Item(4)) Then
                        pdfFormFields.SetField(pdfFieldPath & "B8[0]", FormatFixedAmount((CDbl(dr.Item(4)) - CDbl(dr2.Item(1)))))
                    End If
                End If
                ...
                'If Not IsDBNull(dr.Item(4)) Then
                '    pdfFormFields.SetField(pdfFieldPath & "B7[0]", FormatFixedAmount(dr.Item(4).ToString))
                'End If
                'If Not IsDBNull(dr.Item(5)) Then
                '    pdfFormFields.SetField(pdfFieldPath & "B8[0]", FormatFixedAmount(dr.Item(5).ToString))
                'End If
            ...
            If dr.Read() Then
                ...
                'End If
                'LeeCC 2012SU2 Borang B end
                If Not IsDBNull(dr("TC_RELIEF")) Then
                    pdfFormFields.SetField(pdfFieldPath & "B19[0]", FormatFixedAmount(dr("TC_RELIEF").ToString))
                End If
            End If
            dr.Close()
            ...
            If dr.Read() Then
                ...
                If Not IsDBNull(dr("TC_AGGREGATE_INCOME")) Then
                    If CDbl(dr("TC_AGGREGATE_INCOME")) <= 96000 Then
                        If CDbl(dr.Item("TC_CHARGEABLE_INCOME") - 2000) <= 0 Then
                            pdfFormFields.SetField(pdfFieldPath & "B20a[0]", "2000")
                            pdfFormFields.SetField(pdfFieldPath & "B20b[0]", "0")
                        Else
                            pdfFormFields.SetField(pdfFieldPath & "B20a[0]", "2000")
                            pdfFormFields.SetField(pdfFieldPath & "B20b[0]", CDbl(dr("TC_CHARGEABLE_INCOME")) - 2000)
                        End If
                    Else
                        pdfFormFields.SetField(pdfFieldPath & "B20a[0]", "0")
                        pdfFormFields.SetField(pdfFieldPath & "B20b[0]", FormatFixedAmount(dr("TC_CHARGEABLE_INCOME").ToString))
                    End If
                End If
                ...
                '    Dim tmpDec As Decimal = IIf(IsNumeric(dr("TC_TAX_FIRST_TAX")), dr("TC_TAX_FIRST_TAX"), 0))
                '    pdfFormFields.SetField(pdfFieldPath & "E2a_2[0]", tmpDec.ToString("N0"))
                '    ' pdfFormFields.SetField(pdfFieldPath & "E2a_2[0]", tmpDec.ToString("N0")) ' Left((FormatFloatingAmount(tmpDec.ToString("N0"), True)), (Len(FormatFloatingAmount(tmpDec.ToString("N0"), True)) - 2)))
                '    'pdfFormFields.SetField(pdfFieldPath & "E2a_2[0]", FormatFloatingAmount(dr("TC_TAX_FIRST_TAX").ToString, True))

                '    ' pdfFormFields.SetField(pdfFieldPath & "E2a_3[0]", Right(FormatFloatingAmount(tmpDec.ToString("N0"), True), 2))
                'End If
                'azham =============
                If Not IsDBNull(dr("TC_TAX_FIRST_TAX")) Then
                    ' Dim tmpDec As Decimal = IIf(IsNumeric(dr("TC_TAX_FIRST_TAX")), dr("TC_TAX_FIRST_TAX"), 0)
                    pdfFormFields.SetField(pdfFieldPath & "E2a_2[0]", FormatFixedAmount(Left(CStr(dr("TC_TAX_FIRST_TAX")), (Len(CStr(dr("TC_TAX_FIRST_TAX"))) - 3)))) 'FormatFixedAmount(Left(tmpDec.ToString("N0")), (Len(tmpDec.ToString("N0")) - 3))))
                End If

                If Not IsDBNull(dr("TC_TAX_FIRST_TAX")) Then
                    ' Dim tmpDec As Decimal = IIf(IsNumeric(dr("TC_TAX_FIRST_TAX")), dr("TC_TAX_FIRST_TAX"), 0)
                    pdfFormFields.SetField(pdfFieldPath & "E2a_3[0]", Right(CStr(dr("TC_TAX_FIRST_TAX")), 2))
                End If
                ...
                If Not IsDBNull(dr("TC_TAX_BALANCE_RATE")) Then
                    ...
                    If Len(dr("TC_TAX_BALANCE_RATE")) > 1 Then
                        pdfFormFields.SetField(pdfFieldPath & "E2b_2[0]", Mid(CStr(dr("TC_TAX_BALANCE_RATE")), 1, 1) & Mid(CStr(dr("TC_TAX_BALANCE_RATE")), 2, 3))
                    Else
                        pdfFormFields.SetField(pdfFieldPath & "E2b_2[0]", Space(9) & dr("TC_TAX_BALANCE_RATE"))
                    End If
                ...
                If Not IsDBNull(dr("TC_TAX_BALANCE_TAX")) Then
                    ...
                    '    '  MsgBox(FormatFixedAmount(Left(CStr(dr("TC_TAX_BALANCE_TAX")), (Len(CStr(dr("TC_TAX_BALANCE_TAX"))) - 3))))
                    pdfFormFields.SetField(pdfFieldPath & "E2b_3[0]", FormatFixedAmount(Left(CStr(dr("TC_TAX_BALANCE_TAX")), (Len(CStr(dr("TC_TAX_BALANCE_TAX"))) - 3))))
                End If
                If Not IsDBNull(dr("TC_TAX_BALANCE_TAX")) Then
                    pdfFormFields.SetField(pdfFieldPath & "E2b_4[0]", Right(CStr(dr("TC_TAX_BALANCE_TAX")), 2))
                End If
                'If Not IsDBNull(dr("TC_TAX_BALANCE_TAX")) Then
                '    Dim tmpDec As Decimal = IIf(IsNumeric(dr("TC_TAX_BALANCE_TAX")), dr("TC_TAX_BALANCE_TAX"), 0)
                '    '  pdfFormFields.SetField(pdfFieldPath & "E2b_3[0]", tmpDec.ToString("N0")) 'Left((FormatFloatingAmount(dr("TC_TAX_BALANCE_TAX").ToString, True)), (Len(FormatFloatingAmount(dr("TC_TAX_BALANCE_TAX").ToString, True)) - 2)))
                '    'pdfFormFields.SetField(pdfFieldPath & "E2b_3[0]", FormatFloatingAmount(dr("TC_TAX_BALANCE_TAX").ToString, True))
                '    '  pdfFormFields.SetField(pdfFieldPath & "E2b_4[0]", Right(FormatFloatingAmount(dr("TC_TAX_BALANCE_TAX").ToString, True), 2))
                'End If
                If Not IsDBNull(dr("TC_TOTAL_INCOME_TAX")) Then
                    pdfFormFields.SetField(pdfFieldPath & "E3_1[0]", Left((FormatFloatingAmount(dr("TC_TOTAL_INCOME_TAX").ToString, True)), (Len(FormatFloatingAmount(dr("TC_TOTAL_INCOME_TAX").ToString, True)) - 2)))
                    pdfFormFields.SetField(pdfFieldPath & "E3_2[0]", Right(FormatFloatingAmount(dr("TC_TOTAL_INCOME_TAX").ToString, True), 2))
                End If
                If Not IsDBNull(dr("TC_REBATES")) Then
                    pdfFormFields.SetField(pdfFieldPath & "E8_1[0]", Left((FormatFloatingAmount(dr("TC_REBATES").ToString, True)), (Len(FormatFloatingAmount(dr("TC_REBATES").ToString, True)) - 2)))
                    pdfFormFields.SetField(pdfFieldPath & "E8_2[0]", Right((FormatFloatingAmount(dr("TC_REBATES").ToString, True)), 2))
                End If
                If Not IsDBNull(dr("TC_INCOME_TAX_CHARGED")) Then
                    pdfFormFields.SetField(pdfFieldPath & "E9_1[0]", Left((FormatFloatingAmount(dr("TC_INCOME_TAX_CHARGED").ToString, True)), (Len(FormatFloatingAmount(dr("TC_INCOME_TAX_CHARGED").ToString, True)) - 2)))
                    pdfFormFields.SetField(pdfFieldPath & "E9_2[0]", Right((FormatFloatingAmount(dr("TC_INCOME_TAX_CHARGED").ToString, True)), 2))
                End If
                If Not IsDBNull(dr("TC_SEC110_DIVIDEND")) Then
                    'pdfFormFields.SetField(pdfFieldPath & "E10_1[0]", Left((CDbl(dr("TC_SEC110_DIVIDEND")).ToString("0.00")), (Len(CDbl(dr("TC_SEC110_DIVIDEND")).ToString("0.00")) - 2)))
                    pdfFormFields.SetField(pdfFieldPath & "E10_1[0]", Left((FormatFloatingAmount(dr("TC_SEC110_DIVIDEND").ToString, True)), (Len(FormatFloatingAmount(dr("TC_SEC110_DIVIDEND").ToString, True)) - 2)))
                    pdfFormFields.SetField(pdfFieldPath & "E10_2[0]", Right((FormatFloatingAmount(dr("TC_SEC110_DIVIDEND").ToString, True)), 2))
                End If
                If Not IsDBNull(dr("TC_SEC110_OTHERS")) Then
                    pdfFormFields.SetField(pdfFieldPath & "E11_1[0]", Left((FormatFloatingAmount(dr("TC_SEC110_OTHERS").ToString, True)), (Len(FormatFloatingAmount(dr("TC_SEC110_OTHERS").ToString, True)) - 2)))
                    pdfFormFields.SetField(pdfFieldPath & "E11_2[0]", Right((FormatFloatingAmount(dr("TC_SEC110_OTHERS").ToString, True)), 2))
                End If
                ...
                If Not IsDBNull(dr.Item(13)) Then
                    ...
                    pdfFormFields.SetField(pdfFieldPath & "E12_1[0]", Left((FormatFloatingAmount(FormatNumber(dr.Item(13), 2).ToString, True)), (Len(FormatFloatingAmount(FormatNumber(dr.Item(13), 2).ToString, True)) - 2)))
                    pdfFormFields.SetField(pdfFieldPath & "E12_2[0]", Right((FormatFloatingAmount(FormatNumber(dr.Item(13), 2).ToString, True)), 2))
                End If
                If Not IsDBNull(dr.Item(14)) Then
                    'pdfFormFields.SetField(pdfFieldPath & "E12[0]", FormatFloatingAmount(dr("TC_1").ToString, True))
                    pdfFormFields.SetField(pdfFieldPath & "B25_1[0]", Left((FormatFloatingAmount(FormatNumber(dr.Item(14), 2).ToString, True)), (Len(FormatFloatingAmount(FormatNumber(dr.Item(14), 2).ToString, True)) - 2)))
                    pdfFormFields.SetField(pdfFieldPath & "B25_2[0]", Right((FormatFloatingAmount(FormatNumber(dr.Item(14), 2).ToString, True)), 2))
                End If
                ...
                If Not IsDBNull(dr("TC_TAX_PAYABLE")) Then
                    pdfFormFields.SetField(pdfFieldPath & "E14_1[0]", Left((FormatFloatingAmount(dr("TC_TAX_PAYABLE").ToString, True)), (Len(FormatFloatingAmount(dr("TC_TAX_PAYABLE").ToString, True)) - 2)))
                    pdfFormFields.SetField(pdfFieldPath & "E14_2[0]", Right((FormatFloatingAmount(dr("TC_TAX_PAYABLE").ToString, True)), 2))
                End If
                If Not IsDBNull(dr("TC_TAX_REPAYMENT")) Then
                    pdfFormFields.SetField(pdfFieldPath & "E15_1[0]", Left((FormatFloatingAmount(dr("TC_TAX_REPAYMENT").ToString, True)), (Len(FormatFloatingAmount(dr("TC_TAX_REPAYMENT").ToString, True)) - 2)))
                    pdfFormFields.SetField(pdfFieldPath & "E15_2[0]", Right((FormatFloatingAmount(dr("TC_TAX_REPAYMENT").ToString, True)), 2))
                End If
                    ...
                    If Not IsDBNull(dr2("TCR_KEY")) Then
                        If Not String.IsNullOrEmpty(dr2("TCR_KEY").ToString) Then
                            Select Case dr2("TCR_KEY")
                                ...
                                Case 3
                                    pdfFormFields.SetField(pdfFieldPath & "E6_1[0]", Left((FormatFloatingAmount(FormatNumber(CDbl(dr2("TCR_AMOUNT")), 2).ToString, True)), Len(FormatFloatingAmount(FormatNumber(CDbl(dr2("TCR_AMOUNT")), 2).ToString, True)) - 2))
                                    pdfFormFields.SetField(pdfFieldPath & "E6_2[0]", Right((FormatFloatingAmount(FormatNumber(CDbl(dr2("TCR_AMOUNT")), 2).ToString, True)), 2))
                                Case 5
            ...
            If dr.Read() Then
                ...
                If Not IsDBNull(dr.Item(1)) Then
                    If Not String.IsNullOrEmpty(dr.Item(1).ToString) Then
                        pdfFormFields.SetField(pdfFieldPath & "F2_1[0]", Left((FormatFloatingAmount(FormatNumber(CDbl(dr.Item(1)), 2).ToString, True)), (Len(FormatFloatingAmount(FormatNumber(CDbl(dr.Item(1)), 2).ToString, True)) - 2)))
                        pdfFormFields.SetField(pdfFieldPath & "F2_2[0]", Right((FormatFloatingAmount(FormatNumber(CDbl(dr.Item(1)), 2).ToString, True)), 2))
                    End If
                End If
                If Not IsDBNull(dr("TC_BALANCE_TAX_PAYABLE")) Then
                    If Not dr("TC_BALANCE_TAX_PAYABLE").ToString = "0.00" Then
                        pdfFormFields.SetField(pdfFieldPath & "B29_1[0]", Left((FormatFloatingAmount(FormatNumber(CDbl(dr("TC_BALANCE_TAX_PAYABLE")), 2).ToString, True)), (Len(FormatFloatingAmount(FormatNumber(CDbl(dr("TC_BALANCE_TAX_PAYABLE")), 2).ToString, True)) - 2)))
                        pdfFormFields.SetField(pdfFieldPath & "B29_2[0]", Right((FormatFloatingAmount(FormatNumber(CDbl(dr("TC_BALANCE_TAX_PAYABLE")), 2).ToString, True)), 2))
                    End If
                End If
                If Not IsDBNull(dr("TC_BALANCE_TAX_OVERPAID")) Then
                    If Not dr("TC_BALANCE_TAX_OVERPAID").ToString = "0.00" Then
                        pdfFormFields.SetField(pdfFieldPath & "B29_0[0]", "X")
                        pdfFormFields.SetField(pdfFieldPath & "B29_1[0]", Left((FormatFloatingAmount(FormatNumber(CDbl(dr("TC_BALANCE_TAX_OVERPAID")), 2).ToString, True)), (Len(FormatFloatingAmount(FormatNumber(CDbl(dr("TC_BALANCE_TAX_OVERPAID")), 2).ToString, True)) - 2)))
                        pdfFormFields.SetField(pdfFieldPath & "B29_2[0]", Right((FormatFloatingAmount(FormatNumber(CDbl(dr("TC_BALANCE_TAX_OVERPAID")), 2).ToString, True)), 2))
                    End If
                End If
            End If
            dr.Close()
                    ...
                    If dr.Read() Then
                        If Not IsDBNull(dr("TP_NAME")) Then
                            If Not String.IsNullOrEmpty(dr("TP_NAME").ToString) Then
                                strArray = SplitText(dr("TP_NAME").ToString, 60)
                                If Not String.IsNullOrEmpty(strArray(0)) Then
            ...
            If Not String.IsNullOrEmpty(pdfForm.GetDeclarationDate) Then
                pdfFormFields.SetField(pdfFieldPath & "Akuan4", FormatDateDash(pdfForm.GetDeclarationDate))
            End If
    ...
    Private Sub Page2()
        ...
        Try
            ...
            ' ==== PART B ==== "
            'azham 18-feb-2016 START == EDIT QUERY====
            strSQL = "select taxp_profile.tp_hw_name, taxp_profile.tp_hw_ref_no_prefix, taxp_profile.tp_hw_ref_no1 , taxp_profile.tp_hw_ref_no2 , taxp_profile.tp_hw_ref_no3,(taxp_profile.tp_hw_ic_new1 + '-' + taxp_profile.tp_hw_ic_new2 + '-' + " _
                        & " taxp_profile.tp_hw_ic_new3), taxp_profile.tp_hw_ic_old,taxp_profile.tp_hw_police_no, taxp_profile.tp_hw_army_no, taxp_profile.tp_hw_passport_no,taxp_profile2.TP_REF_NO,taxp_profile2.TP_HW_DOB" _
                        & " from taxp_profile inner join taxp_profile2 on (taxp_profile.tp_ref_no1 + taxp_profile.tp_ref_no2 + taxp_profile.tp_ref_no3)=taxp_profile2.TP_REF_NO" _
                        & " where (taxp_profile.tp_ref_no1 + taxp_profile.tp_ref_no2 + taxp_profile.tp_ref_no3)=?"
            ds = datHandler.GetData(strSQL, prmOledb)
            'azham 18-feb-2016 END == EDIT QUERY====
            ReDim strArray(1)
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                If Not IsDBNull(ds.Tables(0).Rows(0).Item(9).ToString) Then
                    If Not String.IsNullOrEmpty(ds.Tables(0).Rows(0).Item(9).ToString) Then
                        pdfFormFields.SetField(pdfFieldPath & "C3[0]", ds.Tables(0).Rows(0).Item(9).ToString)
                    End If
                End If
                'azham 18-feb-2016 START =====================================================================
                If Not IsDBNull(ds.Tables(0).Rows(0).Item(11)) Then
                    If Not String.IsNullOrEmpty(ds.Tables(0).Rows(0).Item(11).ToString) Then

                        pdfFormFields.SetField(pdfFieldPath & "C4[0]", Format(CDate(ds.Tables(0).Rows(0).Item(11).ToString), "dd-MM-yyyy"))
                    End If
                End If
                'azham 18-feb-2016 end =====================================================================
            End If
            ds.Clear()
            ...
            Try
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    pdfFormFields.SetField(pdfFieldPath & "K3[0]", IIf(IsDBNull(ds.Tables(0).Rows(0).Item(25)), "", ds.Tables(0).Rows(0).Item(25).ToString) & _
                                           IIf(IsDBNull(ds.Tables(0).Rows(0).Item(26)), "", ds.Tables(0).Rows(0).Item(26).ToString))
            ...
            If dr.Read Then
                ...
                ReDim intCounter2(2)
                ReDim intArrayChild50(6)
                ReDim intArrayChild100(6)
                        ...
                        Select Case dr2("TCC_KEY")
                            Case 14
                                ...
                                If Not IsDBNull(dr2("TCC_100")) And Not String.IsNullOrEmpty(Trim(dr2("TCC_100"))) And Not Trim(dr2("TCC_100")) = "" Then
                                    If CDbl(Trim(dr2("TCC_100"))) = 2000 Then
                                ...
                                If Not IsDBNull(dr2("TCC_50")) And Not String.IsNullOrEmpty(Trim(dr2("TCC_50"))) And Not Trim(dr2("TCC_50")) = "" Then
                                    If CDbl(Trim(dr2("TCC_50"))) = 1000 Then
                            ...
                            Case 15
                                If Not IsDBNull(dr2("TCC_100")) And Not String.IsNullOrEmpty(Trim(dr2("TCC_100"))) And Not Trim(dr2("TCC_100")) = "" Then
                                    ...
                                    ElseIf CDbl(Trim(dr2("TCC_100"))) = 8000 Then
                                ...
                                If Not IsDBNull(dr2("TCC_50")) And Not String.IsNullOrEmpty(Trim(dr2("TCC_50"))) And Not Trim(dr2("TCC_50")) = "" Then
                                    ...
                                    ElseIf CDbl(Trim(dr2("TCC_50"))) = 4000 Then
                                        intArrayChild50(3) = intArrayChild50(3) + 1
                                    End If
                                End If
                            Case 16
                                If Not IsDBNull(dr2("TCC_100")) And Not String.IsNullOrEmpty(Trim(dr2("TCC_100"))) And Not Trim(dr2("TCC_100")) = "" Then
                                    If CDbl(Trim(dr2("TCC_100"))) = 6000 Then
                                        intArrayChild100(4) = intArrayChild100(4) + 1
                                    ElseIf CDbl(Trim(dr2("TCC_100"))) = 14000 Then
                                        intArrayChild100(5) = intArrayChild100(5) + 1
                                    End If
                                End If
                                If Not IsDBNull(dr2("TCC_50")) And Not String.IsNullOrEmpty(Trim(dr2("TCC_50"))) And Not Trim(dr2("TCC_50")) = "" Then
                                    If CDbl(Trim(dr2("TCC_50"))) = 3000 Then
                                        intArrayChild50(4) = intArrayChild50(4) + 1
                                    ElseIf CDbl(Trim(dr2("TCC_50"))) = 7000 Then
                ...
                For i As Integer = 1 To 5
                    Select Case i
                        Case 1
                            pdfFormFields.SetField(pdfFieldPath & "D11a_1[0]", intArrayChild100(1).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "D11a_2[0]", intArrayChild100(1) * 2000)
                            pdfFormFields.SetField(pdfFieldPath & "D11a_3[0]", intArrayChild50(1).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "D11a_4[0]", intArrayChild50(1) * 1000)
                        Case 2
                            pdfFormFields.SetField(pdfFieldPath & "D11b1_1[0]", intArrayChild100(2).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "D11b1_2[0]", intArrayChild100(2) * 2000)
                            pdfFormFields.SetField(pdfFieldPath & "D11b1_3[0]", intArrayChild50(2).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "D11b1_4[0]", intArrayChild50(2) * 1000)
                        Case 3
                            pdfFormFields.SetField(pdfFieldPath & "D11b2_1[0]", intArrayChild100(3).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "D11b2_2[0]", intArrayChild100(3) * 8000)
                            pdfFormFields.SetField(pdfFieldPath & "D11b2_3[0]", intArrayChild50(3).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "D11b2_4[0]", intArrayChild50(3) * 4000)
                        Case 4

                            pdfFormFields.SetField(pdfFieldPath & "D11c1_1[0]", intArrayChild100(4).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "D11c1_2[0]", intArrayChild100(4) * 6000)
                            pdfFormFields.SetField(pdfFieldPath & "D11c1_3[0]", intArrayChild50(4).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "D11c1_4[0]", intArrayChild50(4) * 3000)
                        Case 5                     
                            pdfFormFields.SetField(pdfFieldPath & "D11c2_1[0]", intArrayChild100(5).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "D11c2_2[0]", intArrayChild100(5) * 14000)
                            pdfFormFields.SetField(pdfFieldPath & "D11c2_3[0]", intArrayChild50(5).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "D11c2_4[0]", intArrayChild50(5) * 7000)
                    End Select
                    intCounter2(0) = intCounter2(0) + intArrayChild50(i) + intArrayChild100(i)
                Next
            End If
            dr.Close()
            'D11 Bilangan anak dituntut oleh diri sendiri
            pdfFormFields.SetField(pdfFieldPath & "D11_2[0]", intCounter2(0).ToString)
            ...
            If boolHasHusbandWife Then
                ...
                For i As Integer = 1 To 5
                    intCounter2(1) = intCounter2(1) + intArrayChild50(i) + intArrayChild100(i)
                Next
            End If
            ...
            pdfFormFields.SetField(pdfFieldPath & "D11_3[0]", intCounter2(1).ToString)

            'D11 Bilangan anak layak mendapat pelepasan
            pdfFormFields.SetField(pdfFieldPath & "D11_1[0]", (intCounter2(0) + intCounter2(1)).ToString)
            ...
            If dr.Read() Then
                If Not IsDBNull(dr("TA_CO_NAME")) Then
                    If Not String.IsNullOrEmpty(dr("TA_CO_NAME")) Then
                        strArray = SplitText(dr("TA_CO_NAME").ToString, 35)
                        pdfFormFields.SetField(pdfFieldPath & "NyataA", strArray(0).ToString.ToUpper)
                        pdfFormFields.SetField(pdfFieldPath & "NyataA_2", strArray(1).ToString.ToUpper)
                    End If
                End If
            ...
            If dr.Read() Then
                If Not IsDBNull(dr("TC_BUSINESS")) Then
                    pdfFormFields.SetField(pdfFieldPath & "B1[0]", FormatFixedAmount(dr("TC_BUSINESS")))
                End If
                If Not IsDBNull(dr("TC_PARTNERSHIP")) Then
                    pdfFormFields.SetField(pdfFieldPath & "B2[0]", FormatFixedAmount(dr("TC_PARTNERSHIP")))
                End If
                If Not IsDBNull(dr("TC_STATUTORY_INCOME")) Then
                    pdfFormFields.SetField(pdfFieldPath & "C7[0]", FormatFixedAmount(dr("TC_STATUTORY_INCOME")))
                End If
                ...
                If Not IsDBNull(dr.Item(7)) Then
                    pdfFormFields.SetField(pdfFieldPath & "C12[0]", FormatFixedAmount(dr.Item(7).ToString))
                End If
                If Not IsDBNull(dr.Item(8)) Then
                    pdfFormFields.SetField(pdfFieldPath & "C13[0]", FormatFixedAmount(dr.Item(8).ToString))
                End If
                If Not IsDBNull(dr("TC_PENSION_AND_ETC")) Then
                    pdfFormFields.SetField(pdfFieldPath & "C14[0]", FormatFixedAmount(dr("TC_PENSION_AND_ETC")))
                End If
                If Not IsDBNull(dr.Item(10)) Then
                    pdfFormFields.SetField(pdfFieldPath & "C15[0]", FormatFixedAmount(dr.Item(10).ToString))
                End If
                If Not IsDBNull(dr("TC_ADDITION_43")) Then
                    pdfFormFields.SetField(pdfFieldPath & "C16[0]", FormatFixedAmount(dr("TC_ADDITION_43")))
                End If
            ...
            'azham 18-feb-2016 ======================
            'ZK========================================================================================
            'strSQL = "select DP_REF_NO,DP_DISPOSAL,DP_DECLARE FROM DISPOSAL WHERE DP_REF_NO= '" & pdfForm.GetRefNo & "' AND DP_YA = '" & pdfForm.GetYA & "'"
            ...
            '=========AZHAM 17-jun-2016================S
            ds.Clear()
            ds = datHandler.GetData("select tc_al_balance_cf,tc_pioneer_cf from tax_computation where tc_ref_no='" & pdfForm.GetRefNo & "' and tc_ya ='" & pdfForm.GetYA & "'")

            If ds IsNot Nothing AndAlso ds.Tables.Count > 0 AndAlso ds.Tables(0).Rows.Count > 0 Then
                If IsDBNull(ds.Tables(0).Rows(0)("tc_al_balance_cf")) = False Then
                    pdfFormFields.SetField(pdfFieldPath & "G1[0]", CInt(ds.Tables(0).Rows(0)("tc_al_balance_cf")))
                Else
                    pdfFormFields.SetField(pdfFieldPath & "G1[0]", "---")
                End If

                If IsDBNull(ds.Tables(0).Rows(0)("tc_pioneer_cf")) = False Then
                    pdfFormFields.SetField(pdfFieldPath & "G2[0]", CInt(ds.Tables(0).Rows(0)("tc_pioneer_cf")))
                Else
            ...
            End If
            ds.Clear()
            ds = datHandler.GetData("select adca_bal_cf from income_adjusted where adj_ref_no='" & pdfForm.GetRefNo & "' and adj_ya = '" & pdfForm.GetYA & "'")
            If ds IsNot Nothing AndAlso ds.Tables.Count > 0 AndAlso ds.Tables(0).Rows.Count > 0 Then
                If IsDBNull(ds.Tables(0).Rows(0)("adca_bal_cf")) = False Then
                    pdfFormFields.SetField(pdfFieldPath & "G3[0]", CInt(ds.Tables(0).Rows(0)("adca_bal_cf")))
                Else
            ...
            ds = datHandler.GetData("select psca_bal_cf from income_partnership where pn_ref_no='" & pdfForm.GetRefNo & "' and pn_ya = '" & pdfForm.GetYA & "'")
            If ds IsNot Nothing AndAlso ds.Tables.Count > 0 AndAlso ds.Tables(0).Rows.Count > 0 Then
                If IsDBNull(ds.Tables(0).Rows(0)("psca_bal_cf")) = False Then
                    pdfFormFields.SetField(pdfFieldPath & "G4[0]", CInt(ds.Tables(0).Rows(0)("psca_bal_cf")))
                Else
    ...
    Private Sub Page3()
        ...
        Try
            ...
            If dr.Read Then
                If Not IsDBNull(dr("tp_name")) Then
                    If Not String.IsNullOrEmpty(dr("tp_name").ToString) Then
                        pdfFormFields.SetField(pdfFieldPath & "Name3", dr("tp_name").ToString.ToUpper)
                    End If
                End If
                If Not String.IsNullOrEmpty(pdfForm.GetRefNo) Then
                    pdfFormFields.SetField(pdfFieldPath & "Ref3", pdfForm.GetRefNo)
                End If
            End If
            dr.Close()
            ...
            If dr.Read() Then
                ...
                If dr2.Read() Then
                    ...
                    If Not IsDBNull(dr2("BC_BUS_ENTITY")) Then
                        If Not String.IsNullOrEmpty(dr2("BC_BUS_ENTITY")) Then
                            strArray = SplitText(dr2("BC_BUS_ENTITY").ToString, 80)
                            If Not String.IsNullOrEmpty(strArray(0)) Then
                    ...
                    If Not IsDBNull(dr2("BC_TYPE")) Then
                        pdfFormFields.SetField(pdfFieldPath & "ZK_6[0]", dr2("BC_TYPE"))
                    Else
                        pdfFormFields.SetField(pdfFieldPath & "ZK_6[0]", "---")
                    End If
                End If
                dr2.Close()
                ...
                If dr2.Read() Then
                    ...
                    If Not IsDBNull(dr2("TP_BUSINESS_ECOMMERCE")) AndAlso dr2("TP_BUSINESS_ECOMMERCE") = "1" Then
                        pdfFormFields.SetField(pdfFieldPath & "D7A_1[0]", "1")
                    Else
                        pdfFormFields.SetField(pdfFieldPath & "D7A_1[0]", "2")
                    End If

                    If Not IsDBNull(dr2("TP_BWA")) Then
                        pdfFormFields.SetField(pdfFieldPath & "D7A_2[0]", dr2("TP_BWA"))
                    Else
                        pdfFormFields.SetField(pdfFieldPath & "D7A_2[0]", "")
                    End If

                    If Not IsDBNull(dr2("TP_JKDM")) AndAlso dr2("TP_JKDM") = "1" Then
                        pdfFormFields.SetField(pdfFieldPath & "D7A_3[0]", "1")
                    Else
                        pdfFormFields.SetField(pdfFieldPath & "D7A_3[0]", "2")
                    End If

                    If Not IsDBNull(dr2("TP_GST")) Then
                        pdfFormFields.SetField(pdfFieldPath & "D7A_4[0]", dr2("TP_GST"))
                    Else
                        pdfFormFields.SetField(pdfFieldPath & "D7A_4[0]", "")
                    End If

                    If Not IsDBNull(dr2("TP_MOTHER_IC")) Then
                        pdfFormFields.SetField(pdfFieldPath & "D7A_6[0]", dr2("TP_MOTHER_IC"))
                    Else
                        pdfFormFields.SetField(pdfFieldPath & "D7A_6[0]", "")
                    End If

                    If Not IsDBNull(dr2("TP_FATHER_IC")) Then
                        pdfFormFields.SetField(pdfFieldPath & "D7A_7[0]", dr2("TP_FATHER_IC"))
                    Else
                        pdfFormFields.SetField(pdfFieldPath & "D7A_7[0]", "")
                    End If
                            ...
                            If Not String.IsNullOrEmpty(dr2("tcc_amount")) Then
                                ...
                                Select Case dr2("tcc_key")
                                    ...
                                    Case 25
                                        ...
                                        'azham 10-03-2017
                                    Case 27
                                        pdfFormFields.SetField(pdfFieldPath & "D7A_8[0]", FormatFixedAmount(dr2("tcc_amount").ToString))
                                        tmpTotal += dr2("tcc_amount")
                                    Case 26
                                        pdfFormFields.SetField(pdfFieldPath & "D7A_9[0]", FormatFixedAmount(dr2("tcc_amount").ToString))
                                        tmpTotal += dr2("tcc_amount")
                                   
                                    Case 28
                                        pdfFormFields.SetField(pdfFieldPath & "D7A_11[0]", FormatFixedAmount(dr2("tcc_amount").ToString))
                                        ' tmpTotal += dr2("tcc_amount")
                                    Case 29
                                        pdfFormFields.SetField(pdfFieldPath & "D7A_20[0]", FormatFixedAmount(dr2("tcc_amount").ToString))
                                    Case 30
                                        pdfFormFields.SetField(pdfFieldPath & "D7A_21[0]", FormatFixedAmount(dr2("tcc_amount").ToString))
                                End Select
                            End If
                        End If
                    End While
                    'weihong
                    pdfFormFields.SetField(pdfFieldPath & "D7A_5[0]", FormatFixedAmount(tmpTotal.ToString))
    ...
    Private Sub Page6()
        ...
        Try
            ...
            If dr.Read() Then
                ...
                'D7A_19
                '  MsgBox("A")
                dr2 = datHandler.GetDataReader("SELECT sum([EXA_AMOUNT]) FROM [PL_EXPENSES] WHERE [EXA_KEY] = " & dr("PL_KEY") & " AND EXA_PLTYPE = 54")
                If dr2.Read() Then
                    If Not IsDBNull(dr2.Item(0)) Then
                        pdfFormFields.SetField(pdfFieldPath & "D7A_19[0]", FormatFixedAmount(dr2.Item(0).ToString))
                        dblTotalValue2 = dblTotalValue2 + CDbl(dr2.Item(0))
                        '  MsgBox("X" & dr2.Item(0).ToString)
                    Else
                        pdfFormFields.SetField(pdfFieldPath & "D7A_19[0]", 0)
                        '  MsgBox("Y")
                    End If
                Else
                    pdfFormFields.SetField(pdfFieldPath & "D7A_19[0]", 0)
        ...
        For Each de In pdfForm.GetReader.AcroFields.Fields
            Select Case (de.Key.ToString.Remove(0, 18))
                ...
                Case "Page2[0].B29_0[0]", _
                    ...
                    pdfFormFields.SetField(de.Key.ToString, RTrim(""))
                Case Else
                    pdfFormFields.SetField(de.Key.ToString, RTrim("00"))
            End Select
