                ...
                For i As Integer = 1 To 5
                    Select Case i
                        ...
                        Case 5
                            ...
                            pdfFormFields.SetField(pdfFieldPath & "F16c_6[0]", intArrayChild100(i) * 12000)
                            pdfFormFields.SetField(pdfFieldPath & "F16c_7[0]", intArrayChild50(i).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "F16c_8[0]", intArrayChild50(i) * 6000)
                    End Select
