        ...
        Try
            ...
            If dr.Read() Then
                ...
                If Not IsDBNull(dr("TC_TAX_FIRST_TAX")) Then
                    pdfFormFields.SetField(pdfFieldPath & "E2a_2[0]", Left((FormatFloatingAmount(dr("TC_TAX_FIRST_TAX").ToString, True)), (Len(FormatFloatingAmount(dr("TC_TAX_FIRST_TAX").ToString, True)) - 2)))
                    'pdfFormFields.SetField(pdfFieldPath & "E2a_2[0]", FormatFloatingAmount(dr("TC_TAX_FIRST_TAX").ToString, True))
                    pdfFormFields.SetField(pdfFieldPath & "E2a_3[0]", Right(FormatFloatingAmount(dr("TC_TAX_FIRST_TAX").ToString, True), 2))
                End If
                ...
                If Not IsDBNull(dr("TC_TAX_BALANCE_TAX")) Then
                    pdfFormFields.SetField(pdfFieldPath & "E2b_3[0]", Left((FormatFloatingAmount(dr("TC_TAX_BALANCE_TAX").ToString, True)), (Len(FormatFloatingAmount(dr("TC_TAX_BALANCE_TAX").ToString, True)) - 2)))
                        ...
                        Select Case dr2("TCC_KEY")
                            ...
                            Case 16
                                If Not IsDBNull(dr2("TCC_100")) And Not String.IsNullOrEmpty(Trim(dr2("TCC_100"))) And Not Trim(dr2("TCC_100")) = "" Then
                                    ...
                                    ElseIf CDbl(Trim(dr2("TCC_100"))) = 12000 Then
                                ...
                                If Not IsDBNull(dr2("TCC_50")) And Not String.IsNullOrEmpty(Trim(dr2("TCC_50"))) And Not Trim(dr2("TCC_50")) = "" Then
                                    ...
                                    ElseIf CDbl(Trim(dr2("TCC_50"))) = 6000 Then
                ...
                For i As Integer = 1 To 5
                    Select Case i
                        ...
                        Case 3
                            ...
                            pdfFormFields.SetField(pdfFieldPath & "D11b2_2[0]", intArrayChild100(i) * 6000)
                            pdfFormFields.SetField(pdfFieldPath & "D11b2_3[0]", intArrayChild50(i).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "D11b2_4[0]", intArrayChild50(i) * 3000)
                        Case 4
                            pdfFormFields.SetField(pdfFieldPath & "D11c1_1[0]", intArrayChild100(i).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "D11c1_2[0]", intArrayChild100(i) * 6000)
                            pdfFormFields.SetField(pdfFieldPath & "D11c1_3[0]", intArrayChild50(i).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "D11c1_4[0]", intArrayChild50(i) * 3000)
                        Case 5
                            pdfFormFields.SetField(pdfFieldPath & "D11c2_1[0]", intArrayChild100(i).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "D11c2_2[0]", intArrayChild100(i) * 12000)
                            pdfFormFields.SetField(pdfFieldPath & "D11c2_3[0]", intArrayChild50(i).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "D11c2_4[0]", intArrayChild50(i) * 6000)
                    End Select
