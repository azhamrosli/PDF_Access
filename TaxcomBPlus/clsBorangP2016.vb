    ...
    Private Sub Page1()
        ...
        Try
            ...
            ds = datHandler.GetData("SELECT PT_NAME, PT_REF_NO," _
                        & " PT_REGISTER_NO, PT_NO_PARTNERS, PT_APPORTIONMENT, PT_COMPLIANCE,PT_BUSINESS_ECOMMERCE,PT_JKDM,PT_GST" _
            ...
            'azham 24/03/2017 
            'EDagang
            If ds.Tables(0).Rows(0).Item(6).ToString = "1" Then
                pdfFormFields.SetField(pdfFieldPath & "D7A_1", "1")
            Else
                pdfFormFields.SetField(pdfFieldPath & "D7A_1", "2")
            End If

            'JKDM
            If ds.Tables(0).Rows(0).Item(7).ToString = "1" Then
                pdfFormFields.SetField(pdfFieldPath & "D7A_3", "1")
            Else
                pdfFormFields.SetField(pdfFieldPath & "D7A_3", "2")
            End If

            'GST
            pdfFormFields.SetField(pdfFieldPath & "D7A_4", "122221")
    ...
    Private Sub Page6()
        ...
        Try
            ...
            If dr.Read Then
                ...
                'Azham 24-03-2017
                'MsgBox(dr("PPL_JKDM"))
                pdfFormFields.SetField(pdfFieldPath & "D7A_5", CDbl(FormatNumber(dr("PPL_JKDM"), 0)))
