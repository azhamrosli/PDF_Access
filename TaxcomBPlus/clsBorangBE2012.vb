    ...
    Private Sub Page1()
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                dr = datHandler.GetDataReader("Select TC_KEY, TC_STATUTORY_INCOME, cdbl(TC_DIVIDEND) + TC_BUSINESSLOSS_BF, TC_AGGREGATE_BUS_INCOME," _
                ...
                If dr.Read() Then
                    ...
                    If dr2.Read() Then
                        If Not (IsDBNull(dr2.Item(0)) And IsDBNull(dr2.Item(1))) Then
                            pdfFormFields.SetField(pdfFieldPath & "B2[0]", CInt((CDbl(dr2.Item(0))) + CDbl(dr2.Item(1))))
                        End If
                    ...
                    If Not IsDBNull(dr("TC_DONATION_GIFT")) Then
                        pdfFormFields.SetField(pdfFieldPath & "B5[0]", dr("TC_DONATION_GIFT"))
                    End If
                ...
                For i As Integer = 1 To 5
                    Select Case i
                        ...
                        Case 3
                            ...
                            pdfFormFields.SetField(pdfFieldPath & "F16b_6[0]", intArrayChild100(i) * 4000)
                            pdfFormFields.SetField(pdfFieldPath & "F16b_7[0]", intArrayChild50(i).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "F16b_8[0]", intArrayChild50(i) * 2000)
                        Case 4
                        ...
                        Case 5
                            ...
                            pdfFormFields.SetField(pdfFieldPath & "F16c_6[0]", intArrayChild100(i) * 9000)
                            pdfFormFields.SetField(pdfFieldPath & "F16c_7[0]", intArrayChild50(i).ToString)
                            pdfFormFields.SetField(pdfFieldPath & "F16c_8[0]", intArrayChild50(i) * 4500)
                    End Select
