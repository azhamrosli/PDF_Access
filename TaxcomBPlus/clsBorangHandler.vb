Public Class clsBorangHandler
    ...
    Private Function CreateBorangCP501() As Object
        Dim objBorangCP501 As New Object
        Select Case (Me.strYA)
            Case "2013"
                objBorangCP501 = New clsBorangCP5012013()
                'sim 20150214
            Case "2014"
                objBorangCP501 = New clsBorangCP5012014()
            Case "2015"
                objBorangCP501 = New clsBorangCP5012015()
            Case "2016"
                objBorangCP501 = New clsBorangCP5012016()
        End Select
        Return objBorangCP501
    End Function
