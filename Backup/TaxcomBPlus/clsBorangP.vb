...
#Region "Insert the page function here"
    Private Sub Page1()
        ...
        Try
            ...
            ds = datHandler.GetData("SELECT PT_NAME, PT_REF_NO," _
                        ...
                        & " FROM TAXP_PROFILE WHERE PT_REF_NO=?", prmOledb)
            ...
            dr = datHandler.GetDataReader("SELECT * FROM [P_BUSINESS_INCOME] WHERE [P_KEY] = " + CStr(PnLKey) + " and [PI_SOURCENO]=1")
            If dr.Read Then
                If dr("PI_TYPE") = "Yes" And dr("PI_PIONEER_INCOME") = 0 Then
                    dr1 = datHandler.GetDataReader("SELECT * FROM [TAXP_PSOURCE] WHERE  [PS_REF_NO]='" + pdfForm.GetRefNo + "' AND PS_YA='" + pdfForm.GetYA + "'")
                    If dr1.Read Then
                        KodPerniagaan = ""
            ...
            dr = datHandler.GetDataReader("SELECT Top 1 * FROM [P_BUSINESS_INCOME] WHERE [P_KEY] = " & PnLKey & " and [PI_SOURCENO]>1 and [PI_TYPE]<>'Yes' ")
            If dr.Read Then
                If dr("PI_PIONEER_INCOME") = 0 Then
                    dr1 = datHandler.GetDataReader("SELECT * FROM [TAXP_PSOURCE] WHERE  [PS_REF_NO]='" + pdfForm.GetRefNo + "' AND PS_YA='" + pdfForm.GetYA + "'  AND PS_SOURCENO=" & dr("PI_SOURCENO") & "")
                    If dr1.Read Then
                        KodPerniagaan = ""
                        KodPerniagaan = dr1("PS_CODE")
    ...
    Private Sub Page2()
        ...
        Try
            ...
            strArray = SplitText(ds.Tables(0).Rows(0).Item(0).ToString().ToUpper, 50)
            RefName = ds.Tables(0).Rows(0).Item(0).ToString.ToUpper
            ...
            While dr.Read
                i = i + 1
                pdfFormFields.SetField(pdfFieldPath & "E" + CStr(i) + "_1", CDbl(dr("PC_CL_CODE")))
    ...
    Private Sub Page3()
        ...
        Try
            ...
            If dr.Read Then
                ReDim strArray(2)
                strArray = SplitText((dr("PT_REG_ADDRESS1").ToString.ToUpper + ", " + dr("PT_REG_ADDRESS2").ToString.ToUpper + ", " + dr("PT_REG_ADDRESS3").ToString.ToUpper).Replace(", ,", ", "), 25)
                ...
                ReDim strArray(2)
                strArray = SplitText((dr("PT_BUS_ADDRESS1").ToString.ToUpper + ", " + dr("PT_BUS_ADDRESS2").ToString.ToUpper + ", " + dr("PT_BUS_ADDRESS3").ToString.ToUpper).Replace(", ,", ", "), 25)
                ...
                ReDim strArray(2)
                strArray = SplitText((dr("PT_COR_ADDRESS1").ToString.ToUpper + ", " + dr("PT_COR_ADDRESS2").ToString.ToUpper + ", " + dr("PT_COR_ADDRESS3").ToString.ToUpper).Replace(", ,", ", "), 25)
                ...
                ReDim strArray(2)
                strArray = SplitText((dr("PT_ACC_ADDRESS1").ToString.ToUpper + ", " + dr("PT_ACC_ADDRESS2").ToString.ToUpper + ", " + dr("PT_ACC_ADDRESS3").ToString.ToUpper).Replace(", ,", ", "), 25)
    ...
    Private Sub Page4()
        ...
        Try
            ...
            While dr1.Read
                ...
                pdfFormFields.SetField(pdfFieldPath & "H" + CStr(i) + "c", dr1("PN_IDENTITY"))
            End While
            dr1.Close()
    ...
    Private Sub Page5()
        ...
        Try
            ...
            For i = 1 To 8
                ...
                pdfFormFields.SetField(pdfFieldPath & "H" + CStr(i) + "f_1", "000")
                pdfFormFields.SetField(pdfFieldPath & "H" + CStr(i) + "f_2", "")
                pdfFormFields.SetField(pdfFieldPath & "H" + CStr(i) + "f_3", "")
                pdfFormFields.SetField(pdfFieldPath & "H" + CStr(i) + "f_4", "")
            Next
            ...
            While dr1.Read
                ...
                If dr1("PN_DATE_APPOINTNENT").ToString <> "" Or Not IsDBNull(dr1("PN_DATE_APPOINTNENT")) Then
                    pdfFormFields.SetField(pdfFieldPath & "H" + CStr(i) + "e_1", FormatDate(dr1("PN_DATE_APPOINTNENT")))
                End If
                If dr1("PN_DATE_CESSATION").ToString <> "" Or Not IsDBNull(dr1("PN_DATE_CESSATION")) Then
                    pdfFormFields.SetField(pdfFieldPath & "H" + CStr(i) + "e_2", FormatDate(dr1("PN_DATE_CESSATION")))
                End If

                pdfFormFields.SetField(pdfFieldPath & "H" + CStr(i) + "f_1", FormatNumber(dr1("PN_SHARE"), 2).ToString.Replace(".", ""))

                If Not IsDBNull(dr1("PN_BENEFIT_1")) Then
                    If dr1("PN_BENEFIT_1").ToString = "1" Then
                        pdfFormFields.SetField(pdfFieldPath & "H" + CStr(i) + "f_2", "1")
                    Else
                        pdfFormFields.SetField(pdfFieldPath & "H" + CStr(i) + "f_2", "")
                    End If
                End If
                If Not IsDBNull(dr1("PN_BENEFIT_2")) Then
                    If dr1("PN_BENEFIT_2").ToString = "1" Then
                        pdfFormFields.SetField(pdfFieldPath & "H" + CStr(i) + "f_3", "2")
                    Else
                        pdfFormFields.SetField(pdfFieldPath & "H" + CStr(i) + "f_3", "")
                    End If
                End If
                If Not IsDBNull(dr1("PN_BENEFIT_3")) Then
                    If dr1("PN_BENEFIT_3").ToString = "1" Then
                        pdfFormFields.SetField(pdfFieldPath & "H" + CStr(i) + "f_4", "3")
                    Else
                        pdfFormFields.SetField(pdfFieldPath & "H" + CStr(i) + "f_4", "")
                    End If
                End If
    ...
    Private Sub Page6()
        ...
        Try
            ...
            If dr.Read Then
                ...
                dr1 = datHandler.GetDataReader("SELECT [PS_CODE] FROM [TAXP_PSOURCE] WHERE [PS_REF_NO]='" + pdfForm.GetRefNo + "' AND PS_YA='" + pdfForm.GetYA + "'")
                If dr1.Read Then
                    parChar = dr1("PS_CODE")
    ...
    Private Sub Page8()
        ...
        Try
            ...
            dr = datHandler.GetDataReader1("SELECT * FROM [TAXA_PROFILE] Where [TA_KEY] =" & pdfForm.GetPartnerTaxAgent)
            If dr.Read Then
                strArray = SplitText(dr("TA_CO_NAME").ToString.ToUpper, 29)
                pdfFormFields.SetField(pdfFieldPath & "NyataA_1", strArray(0))
                pdfFormFields.SetField(pdfFieldPath & "NyataA_2", strArray(1))

                ReDim strArray(2)
                strArray = SplitText((dr("TA_ADD_LINE1").ToString.ToUpper + ", " + dr("TA_ADD_LINE2").ToString.ToUpper + ", " + dr("TA_ADD_LINE3").ToString.ToUpper).Replace(", ,", ", "), 25)
                strTemp = strArray(0)
